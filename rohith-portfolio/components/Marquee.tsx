...
export default function Marquee() {
  return (
    <div className="marquee-band relative left-1/2 mb-28 w-screen -translate-x-1/2 overflow-hidden border-y border-[var(--color-rule)] bg-transparent py-8 md:mb-36 md:py-10">
